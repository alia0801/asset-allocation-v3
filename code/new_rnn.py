...
class Attention_lstm(keras.Model):
    def __init__(self,units):
        ...
        self.lstm_en = layers.RNN( keras.layers.LSTMCell(units,dropout=0.2), input_shape=(63,3), return_sequences=True,unroll=True)
...
if __name__ == '__main__':
    ...
    mse, predict_price = atten_lstm(batchsz,units,epochs,window_size_x,window_size_y,data_to_use,data_a_month,'atten_lstm_0919_2.png',lstm_filepath)
