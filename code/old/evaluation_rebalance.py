...
def get_rewards(y,nnnn,choose,weight,mode=3):
    # print(choose,weight)
...
def train_choose(y,month,choose,weight,mode=3):
    print(choose,weight)
    nnnn = 1
    if y>today.year:
        print('y too big')
...
# %%
def test_choose(y,month,choose,weight,mode=3):
    print(choose,weight)
    nnnn = 1/12
    if y+nnnn>today.year:
        print('y+nnnn too big')
    ...
    for i in range(len(input_money)):
        if input_money[i]==first_input_total:
            iiiii = i
        else:
            break
    # total_input_money = first_input_total+input_month_total*(len(sum_money_mmm)-1)
    total_input_money = first_input_total
    # print(sum_money[-1],total_input_money)
...
def money_sim(choose,weight,df2,start_date,mode):
    # choose = []
...
def cal_success_ratio(y,nnnn,choose,weight,expect_r,mode):
...
# %%
def slidwindow(y,nnnn,choose,weight,expect_r,mode):
    print('slidwindow:')
    ...
    return success_ratio,success,stat,stat_list        
# %%
def get_all_value(y,month,choose,weight,mode=4):
    ans = test_choose(y,month,choose,weight,mode) # reward,annual_reward,v1_std,mdd,success_ratio,success
